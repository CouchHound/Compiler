        ...
        for part in tac_dict[key]:
            ...
            if len(part) > 3 and part[3] == '+':
                if type(part[2]) != (int or float) and type(part[4]) == int:
                    MIPS_CODE['.text'][key].\
                        append(
                            'addi $' + str(part[0][1:]) + ', $' + str(part[2][1:]) + ', ' + str(part[4]))

                elif type(part[2]) == int and type(part[4]) != (int or float):
                    MIPS_CODE['.text'][key].\
                        append(
                            'addi $' + str(part[0][1:]) + ', $' + str(part[4][1:]) + ', ' + str(part[2]))
                elif part[0][0:2] == '_f' and part[2][0:2] == '_f' and part[4][0:2] == '_f':
                    MIPS_CODE['.text'][key]. \
                        append(
                            'add.s $' + str(part[0][1:]) + ', $' + str(part[2][1:]) + ', $' + str(part[4][1:]))

                else:
                    MIPS_CODE['.text'][key]. \
                        append(
                            'addu $' + str(part[0][1:]) + ', $' + str(part[2][1:]) + ', $' + str(part[4][1:]))

            elif len(part) > 3 and part[3] == '-':
                if type(part[2]) != (int or float) and type(part[4]) == (int or float):
                    MIPS_CODE['.text'][key]. \
                        append(
                            'sub $' + str(part[0][1:]) + ', $' + str(part[2][1:]) + ', ' + str(part[4]))

                elif type(part[2]) == (int or float) and type(part[4]) != (int or float):
                    MIPS_CODE['.text'][key]. \
                        append(
                            'sub $' + str(part[0][1:]) + ', $' + str(part[4][1:]) + ', ' + str(part[2]))

                elif part[0][0:2] == '_f' and part[2][0:2] == '_f' and part[4][0:2] == '_f':
                    MIPS_CODE['.text'][key]. \
                        append(
                            'sub.s $' + str(part[0][1:]) + ', $' + str(part[2][1:]) + ', $' + str(part[4][1:]))

                else:
                    MIPS_CODE['.text'][key]. \
                        append(
                            'subu $' + str(part[0][1:]) + ', $' + str(part[2][1:]) + ', $' + str(part[4][1:]))

            elif len(part) > 3 and part[3] == '*':
                if type(part[2]) != (int or float) and type(part[4]) == (int or float):
                    MIPS_CODE['.text'][key]. \
                        append(
                            'mul $' + str(part[0][1:]) + ', $' + str(part[2][1:]) + ', ' + str(part[4]))

                elif type(part[2]) == (int or float) and type(part[4]) != (int or float):
                    MIPS_CODE['.text'][key]. \
                        append(
                            'mul $' + str(part[0][1:]) + ', $' + str(part[4][1:]) + ', ' + str(part[2]))

                elif part[0][0:2] == '_f' and part[2][0:2] == '_f' and part[4][0:2] == '_f':
                    MIPS_CODE['.text'][key]. \
                        append(
                            'mul.s $' + str(part[0][1:]) + ', $' + str(part[2][1:]) + ', $' + str(part[4][1:]))

                else:
                    MIPS_CODE['.text'][key]. \
                        append(
                            'mul $' + str(part[0][1:]) + ', $' + str(part[2][1:]) + ', $' + str(part[4][1:]))

            elif len(part) > 3 and part[3] == '/':
                if type(part[2]) != (int or float) and type(part[4]) == (int or float):
                    MIPS_CODE['.text'][key].\
                        append(
                            'div $' + str(part[0][1:]) + ', $' + str(part[2][1:]) + ', ' + str(part[4]))

                elif type(part[2]) == (int or float) and type(part[4]) != (int or float):
                    MIPS_CODE['.text'][key]. \
                        append(
                            'div $' + str(part[0][1:]) + ', $' + str(part[4][1:]) + ', ' + str(part[2]))

                elif part[0][0:2] == '_f' and part[2][0:2] == '_f' and part[4][0:2] == '_f':
                    MIPS_CODE['.text'][key]. \
                        append(
                            'div.s $' + str(part[0][1:]) + ', $' + str(part[2][1:]) + ', $' + str(part[4][1:]))

                else:
                    MIPS_CODE['.text'][key]. \
                        append(
                            'div $' + str(part[0][1:]) + ', $' + str(part[2][1:]) + ', $' + str(part[4][1:]))
                ...
                if type(part[1]) != (int or float) and type(part[3]) == (int or float):
                    if part[2] == '==':
                        MIPS_CODE['.text'][key]. \
                            append(
                                'beq $' + str(part[1][1:]) + ', ' + str(part[3]) + ', ' + str(part[5]))
                    elif part[2] == '<':
                        MIPS_CODE['.text'][key]. \
                            append(
                                'blt $' + str(part[1][1:]) + ', ' + str(part[3]) + ', ' + str(part[5]))
                    elif part[2] == '<=':
                        MIPS_CODE['.text'][key]. \
                            append(
                                'ble $' + str(part[1][1:]) + ', ' + str(part[3]) + ', ' + str(part[5]))
                    elif part[2] == '>':
                        MIPS_CODE['.text'][key]. \
                            append(
                                'bgt $' + str(part[1][1:]) + ', ' + str(part[3]) + ', ' + str(part[5]))
                    elif part[2] == '>=':
                        MIPS_CODE['.text'][key]. \
                            append(
                                'bge $' + str(part[1][1:]) + ', ' + str(part[3]) + ', ' + str(part[5]))
                    elif part[2] == '!=':
                        MIPS_CODE['.text'][key]. \
                            append(
                                'bne $' + str(part[1][1:]) + ', ' + str(part[3]) + ', ' + str(part[5]))

                elif part[1][0:2] == '_f' and part[3][0:2] == '_f':
                    if part[2] == '==':
                        MIPS_CODE['.text'][key]. \
                            append('c.eq.s $' +
                                   str(part[1][1:]) + ', $' + str(part[3][1:]))
                    elif part[2] == '<':
                        MIPS_CODE['.text'][key]. \
                            append('c.lt.s $' +
                                   str(part[1][1:]) + ', $' + str(part[3][1:]))
                    ...
                    if part[2] == '==':
                        MIPS_CODE['.text'][key]. \
                            append(
                                'beq $' + str(part[1][1:]) + ', $' + str(part[3][1:]) + ', ' + str(part[5]))
                    elif part[2] == '<':
                        MIPS_CODE['.text'][key]. \
                            append(
                                'blt $' + str(part[1][1:]) + ', $' + str(part[3][1:]) + ', ' + str(part[5]))
                    elif part[2] == '<=':
                        MIPS_CODE['.text'][key]. \
                            append(
                                'ble $' + str(part[1][1:]) + ', $' + str(part[3][1:]) + ', ' + str(part[5]))
                    elif part[2] == '>':
                        MIPS_CODE['.text'][key]. \
                            append(
                                'bgt $' + str(part[1][1:]) + ', $' + str(part[3][1:]) + ', ' + str(part[5]))
                    elif part[2] == '>=':
                        MIPS_CODE['.text'][key]. \
                            append(
                                'bge $' + str(part[1][1:]) + ', $' + str(part[3][1:]) + ', ' + str(part[5]))
                    elif part[2] == '!=':
                        MIPS_CODE['.text'][key]. \
                            append(
                                'bne $' + str(part[1][1:]) + ', $' + str(part[3][1:]) + ', ' + str(part[5]))
                    elif part[2] == 'and':
                        MIPS_CODE['.text'][key]. \
                ...
                for i in part[2]:
                    if type(i) != (int and float):
                        if i in TAC.list_of_registr:
                            MIPS_CODE['.text'][key].\
                                append(
                                    'move $s' + str(find_var(part[1][1:])+1) + ', $s' + str(TAC.list_of_registr.index(i)+1))
                        elif i in TAC.list_of_float:
                            MIPS_CODE['.text'][key]. \
                                append(
                                    'move $f' + str(find_var(part[1][1:])+1) + ', $f' + str(TAC.list_of_float.index(i) + 1))
                    elif type(i) == int:
                        MIPS_CODE['.text'][key]. \
                ...
                if part[0][0:2] == "_t" and type(part[2]) == int:
                    ...
                    MIPS_CODE['.text'][key].\
                        append(
                            'li.s $' + str(part[0][1:]) + ', ' + str(part[2]))
                elif part[0][0:2] == "_t" and type(part[2]) != int:
                    if part[2] in list_of_a:
                        MIPS_CODE['.text'][key]. \
                            append(
                                'move $' + str(part[0][1:]) + ', $a' + str(list_of_a.index(part[2])))
                    else:
                        MIPS_CODE['.text'][key]. \
                            append(
                                'move $' + str(part[0][1:]) + ', $' + str(part[2][1:]))

                elif part[0][0:2] == "_f" and type(part[2]) != float:
                    MIPS_CODE['.text'][key]. \
                        append('mov.s $' +
                               str(part[0][1:]) + ', $' + str(part[2][1:]))
                elif part[0][0:2] == "_s":
                    if type(part[2]) == int:
                        MIPS_CODE['.text'][key]. \
                            append(
                                'li $' + str(part[0][1:]) + ', ' + str(part[2]))
                        ...
                        MIPS_CODE['.text'][key]. \
                            append(
                                'move $' + str(part[0][1:]) + ', $a' + str(list_of_a.index(ret_func_var(part[2][7:]))))
                    else:
                        MIPS_CODE['.text'][key]. \
                            append(
                                'move $' + str(part[0][1:]) + ', $' + str(part[2][1:]))
